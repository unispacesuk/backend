...
CREATE SEQUENCE THREAD_REPLIES_ID_AI;
CREATE TABLE thread_replies (
    _id INTEGER NOT NULL DEFAULT NEXTVAL('THREAD_REPLIES_ID_AI'),
    user_id INTEGER NOT NULL REFERENCES users (_id),
...
ALTER SEQUENCE THREAD_REPLIES_ID_AI OWNED BY thread_replies._id;